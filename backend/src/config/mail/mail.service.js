...
var MailService = function () {
    ...
    var MailService = _classThis = /** @class */ (function () {
        ...
        MailService_1.prototype.sendEmail = function (to, subject, html) {
        ...
        MailService_1.prototype.sendResetPasswordEmail = function (to, token) {
            return __awaiter(this, void 0, void 0, function () {
                var resetUrl, html;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.sendEmail(to, 'Réinitialisation du mot de passe - AMKA', html)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
