...
var AuthController = function () {
    ...
    var AuthController = _classThis = /** @class */ (function () {
        ...
        AuthController_1.prototype.login = function (loginDto, response) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.authService.login(loginDto, response)];
                });
            });
        };
        ...
        AuthController_1.prototype.logout = function (userId, response) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.authService.logout(userId, response)];
                });
            });
        };
        AuthController_1.prototype.changePassword = function (userId, changePasswordDto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.authService.changePassword(userId, changePasswordDto)];
                });
            });
        };
        ...
        AuthController_1.prototype.getProfile = function (user) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.authService.getProfile(user.id)];
                });
            });
        };
    ...
    (function () {
        ...
        _login_decorators = [(0, common_1.Post)('login'), (0, public_decorator_1.Public)()];
        ...
        _forgotPassword_decorators = [(0, common_1.Post)('forgot-password'), (0, public_decorator_1.Public)()];
        _resetPassword_decorators = [(0, common_1.Post)('reset-password'), (0, public_decorator_1.Public)()];
