    ...
    var UsersService = _classThis = /** @class */ (function () {
        ...
        UsersService_1.prototype.findAll = function (query) {
            return __awaiter(this, void 0, void 0, function () {
                var _a, page, _b, limit, search, role, isActive, skip, where, _c, users, total;
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
                            _a = query.page, page = _a === void 0 ? 1 : _a, _b = query.limit, limit = _b === void 0 ? 10 : _b, search = query.search, role = query.role, isActive = query.isActive;
                            skip = (page - 1) * limit;
                            where = {};
                            if (search) {
                                where.OR = [
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            user = _a.sent();
                            if (!user) {
                                throw new common_1.NotFoundException("Utilisateur avec ID ".concat(id, " non trouv\u00E9"));
                            }
        ...
        UsersService_1.prototype.assignRole = function (id, assignRoleDto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.findById(id)];
            ...
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.sent();
                            return [2 /*return*/, this.prisma.user.delete({ where: { id: id } })];
                    }
                });
            });
        };
        UsersService_1.prototype.activate = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.findById(id)];
        ...
        UsersService_1.prototype.deactivate = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.findById(id)];
