...
var UsersController = function () {
    ...
    var UsersController = _classThis = /** @class */ (function () {
        ...
        UsersController_1.prototype.assignRole = function (id, assignRoleDto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.usersService.assignRole(id, assignRoleDto)];
                });
            });
        };
        ...
        UsersController_1.prototype.activate = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.usersService.activate(id)];
                });
            });
        };
        UsersController_1.prototype.deactivate = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.usersService.deactivate(id)];
                });
            });
        };
    ...
    (function () {
        ...
        _findById_decorators = [(0, common_1.Get)(':id'), (0, roles_decorator_1.Roles)(client_1.Role.ADMIN)];
        _create_decorators = [(0, common_1.Post)(), (0, roles_decorator_1.Roles)(client_1.Role.ADMIN)];
        _update_decorators = [(0, common_1.Put)(':id'), (0, roles_decorator_1.Roles)(client_1.Role.ADMIN)];
        _assignRole_decorators = [(0, common_1.Put)(':id/role'), (0, roles_decorator_1.Roles)(client_1.Role.ADMIN)];
        _delete_decorators = [(0, common_1.Delete)(':id'), (0, roles_decorator_1.Roles)(client_1.Role.ADMIN)];
        _activate_decorators = [(0, common_1.Post)(':id/activate'), (0, roles_decorator_1.Roles)(client_1.Role.ADMIN)];
        _deactivate_decorators = [(0, common_1.Post)(':id/deactivate'), (0, roles_decorator_1.Roles)(client_1.Role.ADMIN)];
