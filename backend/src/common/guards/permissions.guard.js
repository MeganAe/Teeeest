...
var PermissionsGuard = function () {
    ...
    var PermissionsGuard = _classThis = /** @class */ (function () {
        function PermissionsGuard_1(reflector, prisma) {
            this.reflector = reflector;
            this.prisma = prisma;
        }
        PermissionsGuard_1.prototype.canActivate = function (context) {
            return __awaiter(this, void 0, void 0, function () {
                var requiredPermissions, user, rolePermissions, userPermissions, hasPermission;
                return __generator(this, function (_a) {
                    ...
                    if (userPermissions.includes('*'))
                        return [2 /*return*/, true];
                    hasPermission = requiredPermissions.some(function (p) { return userPermissions.includes(p); });
                    if (!hasPermission)
