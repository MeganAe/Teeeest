...
var PDFUtil = /** @class */ (function () {
    ...
    PDFUtil.generateReceipt = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve) {
                        ...
                        doc.moveDown();
                        doc.text("Num\u00E9ro: ".concat(data.receiptNumber));
                        doc.text("Date: ".concat(new Date(data.date).toLocaleDateString()));
                        doc.text("Patient: ".concat(data.patientName));
                        doc.text("Montant: ".concat(data.amount, " FC"));
                        doc.text("Mode: ".concat(data.method));
                        doc.moveDown();
